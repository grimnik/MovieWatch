...
{
    public partial class MadeDatabaseEntries : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Beschrijving = table.Column<string>(maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFilmGeziens", x => new { x.FilmId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserFilmGeziens_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFilmGeziens_GezienStatuses_GezienStatusId",
                        column: x => x.GezienStatusId,
                        principalTable: "GezienStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFilmGeziens_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFilmGeziens_GezienStatusId",
                table: "UserFilmGeziens",
                column: "GezienStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFilmGeziens_UserId",
                table: "UserFilmGeziens",
                column: "UserId");
        }
